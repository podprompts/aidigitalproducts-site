...
'@
Set-Content -Path "src\app\api\vendor\upload-video\presign\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\upload-video\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\upload-file\presign\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\upload-file\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\images\presign\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\images\confirm\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\images\reorder\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\images\[id]\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\api\vendor\products\[id]\route.ts" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\vendor\(protected)\products\[id]\edit\EditForm.tsx" -Value $content -NoNewline
...
'@
Set-Content -Path "src\app\vendor\(protected)\products\[id]\edit\page.tsx" -Value $content -NoNewline
