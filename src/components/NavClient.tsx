...
interface Props {
  vendorInfo: VendorNavInfo | null;
}

export default function NavClient({ vendorInfo }: Props) {
    ...
    <>
      <nav className="nav" style={{ top: 0 }}>
        ...
        <ul className="flex items-center gap-9 list-none" style={{ flexShrink: 0 }}>
          ...
          {vendorInfo ? (
            <li className="nav-mobile-hide" style={{ display: "flex", alignItems: "center", gap: "14px" }}>
              <Link
                href="/vendor/dashboard"
                style={{ display: "flex", alignItems: "center", gap: "8px", textDecoration: "none" }}
              >
                <VendorAvatarBadge url={vendorInfo.avatarUrl} size={26} alt={vendorInfo.displayName} />
      ...
      <div className={`nav-overlay${menuOpen ? " open" : ""}`} aria-hidden={!menuOpen}>
        ...
        {vendorInfo ? (
          <>
            ...
            >
              <VendorAvatarBadge url={vendorInfo.avatarUrl} size={24} alt={vendorInfo.displayName} />
              Dashboard
            </Link>
