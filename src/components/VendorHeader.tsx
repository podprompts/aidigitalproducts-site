    ...
    <>
      ...
      >
        ...
        <div className="nav-mobile-hide" style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          ...
          <a href="/vendor/support" style={{ fontSize: "13px", fontWeight: 600, color: "var(--ink-faded)", textDecoration: "none" }}>
            Support
          </a>
          <a href="/vendor/reviews" style={{ fontSize: "13px", fontWeight: 600, color: "var(--ink-faded)", textDecoration: "none" }}>
            Reviews
          </a>
          <a href="/vendor/messages" style={{ fontSize: "13px", fontWeight: 600, color: "var(--ink-faded)", textDecoration: "none" }}>
            Messages
          </a>
      ...
      <div className={`nav-overlay${menuOpen ? " open" : ""}`} aria-hidden={!menuOpen}>
        ...
        <a href="/vendor/support" className="nav-overlay-link" onClick={close}>
          Support
        </a>
        <a href="/vendor/reviews" className="nav-overlay-link" onClick={close}>
          Reviews
        </a>
        <a href="/vendor/messages" className="nav-overlay-link" onClick={close}>
          Messages
        </a>
