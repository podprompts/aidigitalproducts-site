# Wires the real vendor refund notification email in, replacing the
# earlier console.log placeholder. Run from the repo root.
...
Write-Host "REPLACED: src\app\api\admin\orders\[id]\refund\route.ts" -ForegroundColor Green
